        ...
        <div class="page-content">
            ...
            <div class="col d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="font-weight-bold mb-0">Best Selling Item</h6>
                            </div>
                            <div class="dropdown ms-auto">
                                <div class="cursor-pointer text-dark font-24 dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown"><i class="bx bx-dots-horizontal-rounded"></i>
                                </div>
                        ...
                        <div class="best-selling-products p-3 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/ice-cream-cornet.png" class="p-1" alt="" />
                                </div>
                                <div class="ps-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/wine-glass.png" class="p-1" alt="" />
                                </div>
                                <div class="ps-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/banana.png" class="p-1" alt="" />
                                </div>
                                <div class="ps-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/telephone.png" class="p-1" alt="" />
                                </div>
                                <div class="ps-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/plate.png" class="p-1" alt="" />
                                </div>
                                <div class="ps-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="product-img">
                                    <img src="admin_asset/assets/images/icons/ice-cream-cornet.png" class="p-1" class="" alt="" />
                                </div>
                                <div class="ps-3">
                                    <h6 class="mb-0 font-weight-bold">Cone Ice Cream</h6>
                                    <p class="mb-0 text-secondary">$29/Each 56 Orders</p>
            ...
            <div class="col d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="font-weight-bold mb-0">Todays Item</h6>
                            </div>
                            <div class="dropdown ms-auto">
                                <div class="cursor-pointer text-dark font-24 dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown"><i class="bx bx-dots-horizontal-rounded"></i>
                                </div>
            ...
            <div class="col d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="font-weight-bold mb-0">Recenly added user</h6>
                            </div>
                            <div class="dropdown ms-auto">
                                <div class="cursor-pointer text-dark font-24 dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown"><i class="bx bx-dots-horizontal-rounded"></i>
                                </div>
                        ...
                        <div class="support-list p-3 mb-3">
                            <div class="d-flex align-items-top">
                                <div class="">
                                    <img src="admin_asset/assets/images/avatars/avatar-1.png" width="45" height="45" class="rounded-circle" alt="" />
                                </div>
                                <div class="ps-2">
                            ...
                            <div class="d-flex align-items-top">
                                <div class="">
                                    <img src="admin_asset/assets/images/avatars/avatar-2.png" width="45" height="45" class="rounded-circle" alt="" />
                                </div>
                                <div class="ps-2">
                            ...
                            <div class="d-flex align-items-top">
                                <div class="">
                                    <img src="admin_asset/assets/images/avatars/avatar-3.png" width="45" height="45" class="rounded-circle" alt="" />
                                </div>
                                <div class="ps-2">
                            ...
                            <div class="d-flex align-items-top">
                                <div class="">
                                    <img src="admin_asset/assets/images/avatars/avatar-4.png" width="45" height="45" class="rounded-circle" alt="" />
                                </div>
                                <div class="ps-2">
                            ...
                            <div class="d-flex align-items-top">
                                <div class="">
                                    <img src="admin_asset/assets/images/avatars/avatar-5.png" width="45" height="45" class="rounded-circle" alt="" />
                                </div>
                                <div class="ps-2">
            ...
            <div class="card radius-10">
                <div class="card-header border-bottom-0 bg-transparent">
                    <div class="d-flex align-items-center">
                        <div>
                            <h5 class="font-weight-bold mb-0">Panding Orders</h5>
                        </div>
                        <div class="ms-auto">
                        ...
                        <table class="table mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-img bg-transparent border">
                                            <img src="admin_asset/assets/images/icons/smartphone.png" class="p-1" alt="">
                                        </div>
                                    </td>
                                    <td>Redmi Airdts</td>
                                    <td>Craig Clayton</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-img bg-transparent border">
                                            <img src="admin_asset/assets/images/icons/mouse.png" class="p-1" alt="">
                                        </div>
                                    </td>
                                    <td>Magic Mouse 2</td>
                                    <td>Julia Burke</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-img bg-transparent border">
                                            <img src="admin_asset/assets/images/icons/tshirt.png" class="p-1" alt="">
                                        </div>
                                    </td>
                                    <td>Coton-T-Shirt</td>
                                    <td>Clark Natela</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-img bg-transparent border">
                                            <img src="admin_asset/assets/images/icons/headphones.png" class="p-1" alt="">
                                        </div>
                                    </td>
                                    <td>Headphones 7</td>
                                    <td>Robin Mandela</td>
